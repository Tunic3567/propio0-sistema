, <template>
  <div class="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
    <NavbarVendedor :rutaAbierta="rutaAbierta" :actualizandoDatos="cargando" :cargandoRuta="cargandoRuta" :tituloSeccion="$t('nav.clientHistory')" @logout="logout" @cerrar-ruta="cerrarRuta" />
      ...
      <div v-if="rutaAbierta || cargandoRuta" class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-600 p-4 transition-colors duration-300">
          <div class="flex items-center gap-2">
            ...
            <span class="text-sm font-medium text-gray-600 dark:text-gray-300">{{ $t('summary.totalClients') }}</span>
          </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-600 p-4 transition-colors duration-300">
          <div class="flex items-center gap-2">
            ...
            <span class="text-sm font-medium text-gray-600 dark:text-gray-300">{{ $t('history.lastRenewal') || 'Última Renovación' }}</span>
          </div>
