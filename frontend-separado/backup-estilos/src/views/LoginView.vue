  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
    ...
    <div class="w-full max-w-md mx-4">
      ...
      <div class="text-center mb-4">
        <!-- Logo integrado B.P.P -->
        <div class="flex flex-col items-center justify-center">
          <!-- Logo para modo claro -->
          <img 
            src="/logo.png" 
            alt="B.P.P Logo" 
            class="w-full max-w-full h-auto dark:hidden"
          />
          ...
          <img 
            src="/logo-dark.png" 
            alt="B.P.P Logo" 
            class="w-full max-w-full h-auto hidden dark:block"
          />
        </div>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
        <form @submit.prevent="login" class="space-y-6">
          <!-- Campo Usuario -->
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" for="usuario">
              {{ t('login.username') }}
            </label>
            <div class="relative">
          ...
          <!-- Campo Contraseña -->
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" for="contrasena">
              {{ t('login.password') }}
            </label>
            <div class="relative">
              <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
