  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-6xl mx-auto p-4">
      <div class="bg-white rounded-lg shadow-md p-6">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">{{ $t('nav.income') }} - {{ $t('admin.title') }}</h1>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">{{ $t('admin.vendors') }}</label>
              <select 
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">{{ $t('admin.routes') }}</label>
              <select 
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">{{ $t('payment.type') }}</label>
              <select 
              ...
              <div class="flex justify-between items-start">
                <div class="flex-1">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    ...
                    <div>
                      <span class="font-medium text-gray-700">{{ $t('admin.city') }}:</span>
