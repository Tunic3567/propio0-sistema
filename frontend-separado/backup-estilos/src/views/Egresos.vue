<template>
  <div class="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
    <NavbarVendedor :rutaAbierta="rutaAbierta" :actualizandoDatos="loading" :cargandoRuta="cargandoRuta" :tituloSeccion="$t('nav.expenses')" @logout="logout" @cerrar-ruta="cerrarRuta" />
    <div class="p-4 max-w-lg mx-auto">
      ...
      <div v-if="rutaAbierta || cargandoRuta" class="bg-white dark:bg-gray-800 rounded shadow p-6 transition-colors duration-300">
        ...
        <div v-else-if="egresos.length === 0" class="text-center text-gray-500 dark:text-gray-400">{{ $t('expense.noMovements') || 'No hay movimientos registrados en esta ruta.' }}</div>
        <div v-else class="space-y-3">
          ...
          <div class="bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded p-3 mb-4 transition-colors duration-300">
            <div class="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <span class="font-semibold text-red-600 dark:text-red-400">🛒 {{ $t('summary.expenses') }}:</span>
