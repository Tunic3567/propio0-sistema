  ...
  <div class="relative w-full max-w-full min-w-0">
    ...
    <Teleport to="body">
      ...
      <div class="p-4 space-y-2 flex-1 overflow-y-auto overscroll-contain sidebar-scroll">
        ...
        <button
          v-if="esSuperUsuario"
          class="w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors text-left border border-blue-400/60 dark:border-blue-600/50"
          :class="[
            isActive('/admin/super/tutoriales') ? 'bg-blue-100 dark:bg-blue-950/50 text-blue-950 dark:text-blue-100 border-l-2 border-blue-600' : 'text-blue-900 dark:text-blue-200 hover:bg-blue-50 dark:hover:bg-blue-950/30'
          ]"
          @click="navigateTo('/admin/super/tutoriales')"
        >
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
